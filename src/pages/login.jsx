...
export default function Login() {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ fontFamily: "sans-serif", fontSize: 28, color: "#fff" }}>
        Track<span style={{ color: "#a259ff" }}>My</span>Spend
      </h1>
      <p style={{ color: "#888", fontFamily: "sans-serif" }}>Sign in to track your finances</p>
      <button
        onClick={handleLogin}
        style={{

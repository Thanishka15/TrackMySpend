...
- View total balance, total income, and total spending in real time
- Interactive pie chart visualization for expense breakdown
- Track monthly expenses and spending trends
...
TrackMySpend works as a Progressive Web App and can be installed on mobile and desktop devices.

## Mobile Installation
1. Open the application in your browser
2. Tap “Add to Home Screen”
3. Launch the app directly from your home screen

## Desktop Installation
1. Open the app in Chrome or Edge
2. Click the install icon in the address bar
3. Install TrackMySpend
